...
class _CIFilterGroup extends CIFilterGroup {
  ...
  Future<CIFilter> getFilter(int index) async {
    try {
  ...
  Future<CIFilter> addFilter(String name) async {
    try {
  ...
  Future<void> removeFilter(CIFilter filter) async {
